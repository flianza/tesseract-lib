...
namespace Tesseract.Lib
{
    public class ProcessRunner : IProcessRunner
    {
        ...
        {
            return this.RunProcessAsync(command, arguments, timeout, environmentVariables).Result;
        }

        private async Task<ProcessResult> RunProcessAsync(string command, IEnumerable<string> arguments = null, int? timeout = null, IEnumerable<KeyValuePair<string, string>> environmentVariables = null)
        {
